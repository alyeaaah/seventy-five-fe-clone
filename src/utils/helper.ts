...
export const profileChecker = ({
  uuid, name, skills, height, media_url, env }: {
  uuid?: string | undefined | null,
  name?: string | undefined | null,
  skills?: PlayerSkillsPayload | undefined | null,
  height?: number | undefined | null,
  media_url?: string | undefined | null,
  env?: boolean
...
const slideUp = (
  ...
  // Read layout properties before any style changes to avoid forced reflows
...
const slideDown = (
  ...
  // Read all layout properties before any style changes to avoid forced reflows
  const height = el.offsetHeight;
