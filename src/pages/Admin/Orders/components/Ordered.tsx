...
export const Ordered = ({openDetail}: {openDetail?: (orderId: string) => void}) => {
  ...
  const actionButtonProcess = (refId: string) => {
    setModalAlert({
      open: true,
                  ...
                  <div>
                    ...
                    <div className="flex justify-end mt-2">
                      ...
                      <Button
                        ...
                        variant="primary"
                        onClick={() => {
                          actionButtonProcess(record.uuid);
                        }}
                      >
