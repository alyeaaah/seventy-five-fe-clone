...
import { TournamentRounds, TournamentsPayload, tournamentsSchema } from "../api/schema";
...
export const TournamentFormPoints = (props: Props) => {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="relative">
          <div className="grid grid-cols-12 gap-4 ">
            ...
            <div className="col-span-12 sm:col-span-6 box h-fit p-4 grid grid-cols-12 ">
              ...
              <div className="col-span-12 grid grid-cols-12 gap-2">
                {
                  detailPointConfig?.data?.points?.map((round, index) => (
                    <div className="col-span-12 grid grid-cols-12 gap-2" key={index}>
                      <div className="col-span-12 sm:col-span-2 sm:flex items-end justify-end">
                        <FormLabel className="font-medium mb-2">Round {round.round} :</FormLabel>
                      </div>
          ...
          <div className="grid grid-cols-12 col-span-12 mt-6">
            <div className="col-span-12 box p-4 flex justify-between" >
              ...
              <div className="flex">
                {tournamentUuid && !!data?.data?.point_config_uuid && <Button
                  type="button"
                  variant="outline-secondary"
                  onClick={() => {
