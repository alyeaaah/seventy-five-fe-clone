...
export const TournamentsApiClient = new Zodios(
  ...
  [
    ...
    endpoints.TournamentsTeamParticipantsApi,
    endpoints.TournamentsUpdateTeamApprovalApi,
    ...
    endpoints.TournamentsUpdateGroupsTeamsApi,
    endpoints.TournamentsAddTeamApi,
    endpoints.TournamentsAddDraftPickApi,
    endpoints.TournamentsUpdateMatchApi,
    endpoints.TournamentsUpdateDraftPickPositionApi,
    endpoints.TournamentsStartDraftPickApi,
    endpoints.TournamentEventsListApi,
    endpoints.TournamentEventsDetailApi,
    endpoints.TournamentEventsCreateApi,
