import { forwardRef, useState, Fragment, ElementType, ComponentPropsWithoutRef, ReactNode, ForwardRefRenderFunction } from "react";
...
type AlertProps<C extends ElementType = "div"> = BaseProps & {
  as?: C;
} & Omit<ComponentPropsWithoutRef<C>, keyof BaseProps | "as">;

type AlertComponent = <C extends ElementType = "div">(
  props: AlertProps<C> & { ref?: ComponentPropsWithoutRef<C>["ref"] }
) => JSX.Element;

const AlertRender: ForwardRefRenderFunction<HTMLDivElement, AlertProps> = (
  { as, dismissible, variant, children, ...props },
  ref
) => {
...
const Alert = forwardRef(AlertRender) as AlertComponent;

type DismissButtonProps<C extends ElementType> = {
  as?: C extends string ? "button" | "a" : C;
} & Omit<ComponentPropsWithoutRef<C>, keyof { as: any }>;

const DismissButton = <C extends ElementType = "button">({
  as,
  children,
  ...props
