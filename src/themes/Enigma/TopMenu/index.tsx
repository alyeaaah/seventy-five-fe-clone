...
function Main() {
  ...
  return (
    <div
      className={clsx([
        "enigma py-5 px-3 md:py-0 sm:px-8 md:px-12 lg:px-20 xl:px-48 2xl:px-54",
    ...
    >
      ...
      <div
        className={clsx([
          "mx-0 sm:mx-4 max-w-full md:max-w-none rounded-[30px] md:rounded-[35px_35px_0_0] px-3 sm:px-4 md:px-[22px] min-w-0 min-h-screen bg-slate-100 flex-1 pb-10 mt-5 relative dark:bg-darkmode-700",
